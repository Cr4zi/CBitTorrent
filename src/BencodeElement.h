...
typedef struct BencodeElement {
    using BencodeType = std::variant<int, std::string_view, std::vector<BencodeElementPtr>, std::map<std::variant<int, std::string_view>, BencodeElementPtr>>;
    BencodeType value;
    ...
    BencodeElement(std::map<std::variant<int, std::string_view>, BencodeElementPtr> map) : value(std::move(map)) {};
